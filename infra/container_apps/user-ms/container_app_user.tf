resource "azapi_resource" "container_app_user" {
        ...
        containers = [
          {
            ...
            image = "ghcr.io/pagopa/selfcare-user-ms:${var.image_tag}"
...
resource "azurerm_key_vault_access_policy" "keyvault_containerapp_access_policy" {
  ...
  object_id    = azapi_resource.container_app_user.identity[0].principal_id
