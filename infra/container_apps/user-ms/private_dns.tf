resource "azurerm_private_dns_a_record" "private_dns_record_a_azurecontainerapps_io" {
  name                = "${azapi_resource.container_app_user.name}.${trimsuffix(data.azurerm_container_app_environment.container_app_environment.default_domain, ".${local.container_app_environment_dns_zone_name}")}"
