...
locals {
  ...
  env_variables = {
    "AZURE_USER_FN_APP_NAME": "${local.project}-user-fn",
    "AZURE_USER_FN_RESOURCE_GROUP": "${local.project}-user-fn-rg",
    "AZURE_USER_FN_SERVICE_PLAN": "${local.project}-user-fn-plan"
  }
  repo_secrets = {
